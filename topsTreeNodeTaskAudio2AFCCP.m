...
%             ppst = {@prepareTutorialStates, self};
            ...
            if self.isReportTask
                states = {...
                    ...
                    'skipCheck'         {}       skcheck  t.interTrialInterval*0.01   {}        'midBlock'        ; ...
                    ...
                    'done'              dnow     {}       t.interTrialInterval*.99   {}         ''             ; ...
                    'skipState'         xsm      {}       0                          {}         ''                ; ... 
                    };
                ...
                if self.taskID == 2  % this is not a tutorial
                    ...
                    states = {...
                        'name'              'entry'  'input'  'timeout'                 'exit'     'next'            ; ...
                        'skipCheck'         {}       skcheck  t.interTrialInterval*0.01  {}         'miniblock'       ; ...
                        'miniblock'         bscreen   {}      0                          skresp     'showFixation'    ; ...
                        'showFixation'      tutent    {}      t.preStim                  gwts       ''       ; ...
                        'waitForChoiceFX'   dque     chkuic   t.choiceTimeout            pdbr       'blank'           ; ...
